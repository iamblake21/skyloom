...
namespace CML.Editor.Art
{
    ...
    public static class StarterIslandUnderbodyBuilder
    {
        ...
        private static readonly RingProfile[] RingProfiles =
        {
            ...
            new RingProfile(1.012f, 0.006f, 0.002f),
            new RingProfile(1.016f, 0.030f, 0.006f),
            new RingProfile(1.006f, 0.055f, 0.010f),
            new RingProfile(1.012f, 0.090f, 0.014f),
            new RingProfile(0.995f, 0.130f, 0.020f),
            new RingProfile(0.980f, 0.180f, 0.030f),
            new RingProfile(0.962f, 0.230f, 0.040f),
            new RingProfile(0.935f, 0.290f, 0.056f),
            new RingProfile(0.905f, 0.350f, 0.070f),
            new RingProfile(0.845f, 0.410f, 0.086f),
            new RingProfile(0.790f, 0.470f, 0.100f),
            new RingProfile(0.720f, 0.530f, 0.112f),
            new RingProfile(0.655f, 0.590f, 0.120f),
            new RingProfile(0.580f, 0.650f, 0.124f),
            new RingProfile(0.500f, 0.710f, 0.120f),
            new RingProfile(0.420f, 0.770f, 0.112f),
            new RingProfile(0.340f, 0.820f, 0.100f),
            new RingProfile(0.265f, 0.870f, 0.086f),
            new RingProfile(0.200f, 0.910f, 0.070f),
            new RingProfile(0.135f, 0.945f, 0.052f),
            new RingProfile(0.080f, 0.970f, 0.036f),
            new RingProfile(0.043f, 0.987f, 0.022f),
            new RingProfile(0.020f, 0.996f, 0.010f)
        };
            ...
            float bottomY)
        {
                 ...
                 ringIndex++)
            {
                     ...
                     rimIndex++)
                {
                    ...
                    scale = Mathf.Clamp(scale, 0.018f, 1.020f);
